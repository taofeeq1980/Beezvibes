...
export const FINDBYUSERID_IDEA_SUCCESS = "FINDBYUSERID_IDEA_SUCCESS";
export const GET_IDEA_SUCCESS = "GET_IDEA_SUCCESS";
export const LIST_IDEA_SUCCESS = "LIST_IDEA_SUCCESS";
export const SEARCHIDEA_IDEA_SUCCESS = "SEARCHIDEA_IDEA_SUCCESS";
